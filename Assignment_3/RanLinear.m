...
for i=0:q-1
    ...
    hold on
    plot(mualin(1),mualin(2),'gs','MarkerSize',10,'MarkerFaceColor',...
        [0,0,0],...
        'DisplayName','Mean of Class A');
    hold on
    plot(mublin(1),mublin(2),'cs','MarkerSize',10,'MarkerFaceColor',...
        [0,0,0],...
    ...
    z = z';
    contour(u,v,z,[0, 0], 'Lin eWidth', 1,'LineColor','b','DisplayName','MED');
    pause
    close all
