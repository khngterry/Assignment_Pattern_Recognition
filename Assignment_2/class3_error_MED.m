...
for n = 1:40
    ...
    for i = 1:400
         z(i) = (Class(i,1)- meanClass3A(1))^2 + (Class(i,2)- meanClass3A(2))^2 ...
                - ((Class(i,1)- meanClass3B(1))^2 + (Class(i,2)- meanClass3B(2))^2);
...
error_MED3(n) = sum(abs(z(1:200)-1)+abs(z(201:400)-2))/380;
end
muError_MED3 = mean(error_MED3);
varError_MED3 = std(error_MED3);