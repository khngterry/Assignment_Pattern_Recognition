...
for n = 1:40
    ...
    for i = 1:400
         z(i) = (Class(i,1)- meanClass2A(1))^2 + (Class(i,2)- meanClass2A(2))^2 ...
                - ((Class(i,1)- meanClass2B(1))^2 + (Class(i,2)- meanClass2B(2))^2);
...
error_MED2(n) = sum(abs(z(1:200)-1)+abs(z(201:400)-2))/380;
end
muError_MED2 = mean(error_MED2);
varError_MED2 = std(error_MED2);