...
saveas(h3,'class3__error_5NN.png');

%% error NN
Class = [rAClass3;rBClass3];
Class(1:200,3) = 1;
Class(201:400,3) = 2;
error_5NN3 = zeros(40,1);
...
error_5NN3(n) = sum(abs(label(1:200)-1)+abs(label(201:400)-2))/380;
end

muError_5NN3 = mean(error_5NN3);
varError_5NN3 = std(error_5NN3);